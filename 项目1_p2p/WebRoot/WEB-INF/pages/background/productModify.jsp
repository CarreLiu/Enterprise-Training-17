...
<script type="text/javascript">
	...
	function checkData() {
		//将编辑框中的内容赋值给隐藏表单域
		$("input[name='productDescription']").val($('#content').html());
		...
		if (rateMsg || amountMsg || linkmanMsg || bankMsg) {
			//不提交表单
			return false;
		}
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form"
				action="${pageContext.request.contextPath}/product/productModifySuccess.do"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="productName"
							placeholder="产品名称" name="productName" value="${product.productName}" readonly>
					</div>
				</div>
					...
					<div class="col-lg-10">
						<div class="input-group col-lg-3" style="float: left;">
							<input type="text" class="form-control" placeholder="最低利率,不填默认为0"
								name="primeLendingRateFrom" value="${product.primeLendingRateFrom}"> <span
						...
						<div class="input-group col-lg-4">
							<input type="text" class="form-control"
								...
								name="primeLendingRateTo" value="${product.primeLendingRateTo}"> <span
								class="input-group-addon">%</span>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="company" placeholder="发行单位" name="companyId" value="${product.company.companyName}"  readonly> 
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<div class="input-group col-lg-5">
							<input type="text" class="form-control"
								placeholder="最高贷款规模,可不填,不填认为贷款规模为固定值" name="financingAmountTo" value="${product.financingAmountTo}"> <span
								class="input-group-addon">万</span>
						</div>
					</div>
					<span id="amountMsg" style="color: red;"></span>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<select data-toggle="select"
							class="form-control select select-default" name="productTypeId">
							<c:forEach items="${productTypes}" var="productType">
								<option value="${productType.productTypeId}"<c:if test="${productType.productTypeId==product.productTypeId}">selected</c:if>>${productType.productTypeName}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<select data-toggle="select"
							class="form-control select select-default" name="lendingPeriodId">
							<c:forEach items="${lendingPeriods}" var="lendingPeriod">
								<option value="${lendingPeriod.lendingPeriodId}" <c:if test="${lendingPeriod.lendingPeriodId==product.lendingPeriodId}">selected</c:if>>${lendingPeriod.period}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="linkman"
							placeholder="联系人" name="linkMan" value="${product.linkMan}">
					</div>
					<span id="linkmanMsg" style="color: red;"></span>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="bank"
							placeholder="联系银行" name="ownedBank" value="${product.ownedBank}">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<div id="content"
							style="overflow:scroll; max-height:300px;border: 1px solid;height: 200px;">${product.productDescription}</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<button type="submit" class="btn btn-lg btn-info"
							style="padding: 15px 60px;border-radius: 0px;">修改</button>
					</div>
				</div>
			</form>
