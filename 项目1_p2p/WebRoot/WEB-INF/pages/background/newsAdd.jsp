...
<head>
	...
	<script type="text/javascript">
		...
		function checkTitleExist() {
			...
			if (newsTitle) {
				$.post(
					'${pageContext.request.contextPath}/news/addCheck.do',
					{"newsTitle":newsTitle},
					function(msg) {
						$('#titleMsg').text(msg);
					}
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		<form class="form-horizontal" role="form"
	  			action="${pageContext.request.contextPath}/news/newsAddPost.do"
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control" id="newsName" placeholder="新闻标题" name="newsTitle">
              </div>
              <span id="titleMsg" style="color:red;"/>
            </div>
            ...
            <div id="content" style="overflow:scroll; max-height:300px;border: 1px solid;height: 1400px;"></div>
         	...
         	<span id="contentMsg" style="color:red;"/>
     </div>
            ...
            <div class="form-group">
                            ...
                            <div class="input-group">
                                 ...
                                 <div>
                                    <span class="btn btn-default btn-file">
                                         ...
                                         <input name="file" type="file" class="default" id="file"/>
                                   </span>
				...
				<div class="form-group">
	              ...
	              <div class="col-lg-10">
	                <input type="radio" name="heading" value="0" checked>不设为头条新闻&nbsp;&nbsp;
	                <input type="radio" name="heading" value="1">设为头条新闻
	              </div>
	            </div>
