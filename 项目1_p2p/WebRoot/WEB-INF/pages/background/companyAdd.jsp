...
<head>
	...
	<script type="text/javascript">
		...
		function checkNameExist() {
			...
			if (companyName) {
				$.post(
					'${pageContext.request.contextPath}/company/addCheck.do',
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		...
	  		<form class="form-horizontal" role="form"
	  			action="${pageContext.request.contextPath}/company/companyAddPost.do"
	  			method="post" onsubmit="return checkData()">
	  		
            <div class="form-group">
              <label for="companyName" class="col-lg-2 control-label">企业名称</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="companyName" placeholder="企业名称" name="companyName">
              </div>
            ...
            <div class="form-group">
            	...
            	<div class="col-lg-10">
			        <div class="input-group col-lg-3" style="float: left;">
			            <input type="text" class="form-control" id="financingInReturn" placeholder="佣金数" name="financingInReturn">
			            <span class="input-group-addon">%</span>
			        </div>
			    </div>
			    <span id="financingMsg" style="color:red;"/>
          	</div>
