    ...
    <script type="text/javascript">
		...
		function initTable(){
        	...
        	$('#cusTable').bootstrapTable({
		        ...
		        url:"${pageContext.request.contextPath}/blog/findBlogByStudent.do",//要请求数据的文件路径
        ...
        function actionFormatter(value,row,index){
			let bid = value;
            let result='';
            result += '<a class="btn btn-success btn-xs" data-toggle="modal" data-target="#modifyBlog" onclick="showModalModify(' + bid + ')">更新</a>&nbsp;&nbsp;&nbsp;';
            result += '<a class="btn btn-danger btn-xs" onclick="showModalDelete(' + bid + ')">删除</a>';
        	return result;
        }
        ...
        function showModalDetail(bid) {
      	...
      	//显示修改确认框
      	function showModalModify(bid) {
      		$.post('${pageContext.request.contextPath}/blog/findById.do', {'bid':bid}, function(blog) {
      			$('#bid').val(blog.bid);
        ...
        //显示删除确认框
   		...
   		function deleteBlog() {
   			//从隐藏表单域取出bid值
   			let bid = $('#del_id').val();
   			window.location.href = "${pageContext.request.contextPath}/blog/deleteBlog2.do?bid=" + bid;
   		}
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">我的日志信息更新</h4>
	      </div>
	      <form action="${pageContext.request.contextPath}/blog/modifyBlog.do" id="frmModifyBlog" class="form-horizontal" method="post">
		      <div class="modal-body">
				  <div class="form-group">
				    <label class="col-sm-10 col-sm-offset-1">日志编号：</label>
				    <div class="col-sm-10 col-sm-offset-1">
				    	<input type="text" class="form-control" readonly="readonly" id="bid" name="bid">
				    </div>
				   </div>
				  <div class="form-group">
				    <label class="col-sm-10 col-sm-offset-1">日志标题：</label>
				    <div class="col-sm-10 col-sm-offset-1">
				    	<input type="text" class="form-control" id="title" name="title">
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="col-sm-10 col-sm-offset-1">日志正文：</label>
				    <div class="col-sm-10 col-sm-offset-1">
