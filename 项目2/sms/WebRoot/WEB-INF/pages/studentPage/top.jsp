    	...
    	<div class="container">
	    	<div class="col-sm-12">
	    		<ul class="nav nav-pills">
				  <li class="active"><a href="${pageContext.request.contextPath}/student/toStudentMain.do">首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</a></li>
				  <li><a href="${pageContext.request.contextPath}/blog/toStudentBlog.do">我的日志</a></li>
				  <li><a href="${pageContext.request.contextPath}/blog/toNewBlog.do">发表日志</a></li>
				  <li class="dropdown">
			          <a href="#" data-toggle="dropdown">预留连接 <span class="caret"></span></a>
			          <ul class="dropdown-menu">
			            <li><a data-toggle="modal" data-target="#modifyStudentInfo" style="cursor:pointer;">更新个人信息</a></li>
