...
<script type="text/javascript">	
    ...
    function loadData(pageNo, pageSize) {
		...
		//获取点击元素中的值
		let typeId = $(".bank_list_tp1 a[class='cur']").attr('value');
		let periodId = $(".bank_list_tp2 a[class='cur']").attr('value');
		let rateFrom = $(".bank_list_tp3 a[class='cur']").attr('from');
		let rateTo = $(".bank_list_tp3 a[class='cur']").attr('to');
		let amountFrom = $(".bank_list_tp4 a[class='cur']").attr('from');
		let amountTo = $(".bank_list_tp4 a[class='cur']").attr('to');
		
        $.ajax({
            url: '${pageContext.request.contextPath}/front/queryCondition.do',
            type: 'post',
            data : {"pageNo":pageNo,"pageSize":pageSize,
            		"typeId":typeId, "periodId":periodId,
            		"rateFrom":rateFrom,"rateTo":rateTo,
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="choices">
        <tr class="bank_list_tp1">
          ...
          <c:forEach items="${typeList}" var="type">
          	<a href="javascript:;" value="${type.productTypeId}">${type.productTypeName}</a>
          </c:forEach>
          </td>
        </tr>
        <tr class="bank_list_tp2">
          ...
          <c:forEach items="${periodList}" var="lend">
          	<a href="javascript:;" value="${lend.lendingPeriodId}">${lend.period}</a>
          </c:forEach>
          </td>
        </tr>
        <tr class="bank_list_tp3">
          ...
          <td align="center" valign="top" class="qb"><a href="javascript:;" class="cur">全部</a></td>
          <td class="txt clear">
          <a href="javascript:;" to="6">6%以下</a>
          <a href="javascript:;" from="6" to="8">6%-8%</a>
          <a href="javascript:;" from="8" to="10">8%-10%</a>
          <a href="javascript:;" from="10" to="12">10%-12%</a>
          <a href="javascript:;" from="12" to="14">12%-14%</a>
          <a href="javascript:;" from="14">14%以上</a></td>
        </tr>
        <tr class="bank_list_tp4">
          <td align="right">贷款规模：</td>
          <td align="center" valign="top" class="qb"><a href="javascript:;" class="cur">全部</a></td>
          <td class="txt clear">
          <a href="javascript:;" to="100">100万以下</a>
          <a href="javascript:;" from="100" to="200">100万-200万</a>
          <a href="javascript:;" from="200" to="300">200万-300万</a>
          <a href="javascript:;" from="300" to="500">300万-500万</a>
          <a href="javascript:;" from="500" to="1000">500万-1000万</a>
          <a href="javascript:;" from="1000">1000万以上</a></td>
        </tr>
      </table>
    </div>
</div>
